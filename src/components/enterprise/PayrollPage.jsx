  ...
  return (
    <div>
      ...
      <div style={{ display: "grid", gap: 8, maxWidth: 720 }}>
        <input style={{ borderRadius: 10, padding: "10px 12px", border: "1px solid rgba(255,255,255,0.16)", background: "#070708", color: "#fff" }} value={companyId} onChange={(e) => setCompanyId(e.target.value)} placeholder="company id" />
        <input style={{ borderRadius: 10, padding: "10px 12px", border: "1px solid rgba(255,255,255,0.16)", background: "#070708", color: "#fff" }} value={recipient} onChange={(e) => setRecipient(e.target.value)} placeholder="recipient 0x..." />
